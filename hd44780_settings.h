...
#define DELAY_RESET              15          // in mS
  ...
  #define LCD_DB1_PORT           PORTD
  #define LCD_DB1_PIN            1
  #define LCD_DB2_PORT           PORTD
  #define LCD_DB2_PIN            2
  #define LCD_DB3_PORT           PORTD
...
#define LCD_E_PIN                5           // Pin for E line
  ...
  #define LCD_E2_PORT            PORTD       // Port for E line
  ...
  #define LCD_E3_PORT            PORTD       // Port for E line
  ...
  #define LCD_E4_PORT            PORTD       // Port for E line
